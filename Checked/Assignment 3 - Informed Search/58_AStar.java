...
public class AStar {
    public static List<int[]> astar(int[][] maze, int[] start, int[] end) {
        ...
        while (!openList.isEmpty()) {
            ...
            // {0, -1}: Move one step up (towards a higher y-coordinate).
            // {0, 1}: Move one step down (towards a lower y-coordinate).
            // {-1, 0}: Move one step left (towards a lower x-coordinate).
            // {1, 0}: Move one step right (towards a higher x-coordinate).
            // {-1, -1}: Move one step diagonally up-left (both x and y decrease by 1).
            // {-1, 1}: Move one step diagonally up-right (x decreases by 1, y increases by 1).
            // {1, -1}: Move one step diagonally down-left (x increases by 1, y decreases by 1).
            // {1, 1}: Move one step diagonally down-right (both x and y increase by 1).
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the start position (row, column):");
        int startRow = scanner.nextInt();
        int startCol = scanner.nextInt();

        System.out.println("Enter the end position (row, column):");
