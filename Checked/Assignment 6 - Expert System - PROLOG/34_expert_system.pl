...
start:-
 ...
 write('Welcome to Vtour'),nl,
 write('Vtour\'s rating is '),format("~2f", [Rating]),nl,
...
checkpass(PassLoc):-
 (PassLoc == 'siddhant',nl, addNewSite;
 PassLoc == 'exit',nl, local;
 PassLoc \== 'siddhant', write('You entered wrong password please rewrite your password.'),nl,nl,
localPassword).
